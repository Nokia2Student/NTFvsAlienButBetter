...
#define XENO_UPGRADE_HIVEMIND_COMBAT "hivemind_combat"

GLOBAL_LIST_INIT(xenoupgradetiers, list(XENO_UPGRADE_BASETYPE, XENO_UPGRADE_INVALID, XENO_UPGRADE_NORMAL, XENO_UPGRADE_PRIMO, XENO_UPGRADE_MANIFESTATION, XENO_UPGRADE_HIVEMIND_COMBAT))
